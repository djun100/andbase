 ...
 * 名称：XYAreaChartActivity
 * 描述：区域图
 * @author amsoft.cn
 * @date 2011-12-13
 * @version
 */
public class XYAreaChartActivity extends AbActivity {
...
private MyApplication application;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAbTitleBar.setTitleText(R.string.area_bar);
	    ...
	    explains.add(new String[] { "蓝色", "点2", "点3", "点4", "", "点6", ""});
